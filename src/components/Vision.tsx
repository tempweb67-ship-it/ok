        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/70 leading-relaxed max-w-3xl mx-auto">
              Every system we build is made with security and a backup plan in mind. 24/7 autonomous systems.
            </p>
    ...
    >
      <div className="relative p-12 md:p-16 rounded-3xl backdrop-blur-md bg-white/5 border border-white/10">
        ...
        <p className="text-lg md:text-xl text-white/70 leading-relaxed">
          We build AI Systems that wont go offline when there's an outage like recent one. System ships fast, gets measured, and improves over time.
        </p>
      </div>
    </motion.div>
  );
