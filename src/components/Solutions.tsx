          ...
          <div className="mt-6 sm:mt-20 pt-6 sm:pt-12 border-t border-white border-opacity-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 sm:gap-6">
              ...
              <Link
                ...
                className="px-6 sm:px-8 py-2.5 sm:py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-1 transition-all duration-300 inline-flex items-center gap-2 whitespace-nowrap text-sm sm:text-base"
              >
