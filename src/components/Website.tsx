      ...
      <div className="pt-20 sm:pt-32 pb-12 sm:pb-20">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          >
            ...
            >
              <Globe size={18} className="text-blue-700 sm:w-5 sm:h-5" />
          ...
          <div className="mb-10 sm:mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {capabilities.map((capability, index) => (
                <div
                  key={index}
                  className="backdrop-blur-md bg-white/20 border border-black/10 rounded-lg p-5 sm:p-8 hover:border-blue-500/30 hover:bg-blue-500/10 transition-all duration-300"
                >
